  ...
  return (
    <>
        ...
        <Container maxWidth="lg">
          <Box className={classes.home_course}>
            ...
            <Box className={classes.home_course_slider}>
              <Grid container>
                <Grid item md={4} sm={4} xs={12}><Slidercourse /></Grid>
                <Grid item md={4} sm={4} xs={12}><Slidercourse /></Grid>
                <Grid item md={4} sm={4} xs={12}><Slidercourse /></Grid>
              </Grid>
            </Box>
          ...
          <Box className={classes.home_course}>
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              <Typography variant="h3" component="h3" className={`${classes.slider_title} ${classes.home_carosol_title_padding}`}>
                Most Popular
              </Typography>
          ...
          <Box className={classes.home_mantor}>
            ...
            <Grid container className={classes.home_mantor_box}>
              <Grid item md={3} sm={3} xs={12}><Mantor /></Grid>
              <Grid item md={3} sm={3} xs={12}><Mantor /></Grid>
              <Grid item md={3} sm={3} xs={12}><Mantor /></Grid>
              <Grid item md={3} sm={3} xs={12}><Mantor /></Grid>
            </Grid>
      ...
      <Box className={classes.home_count_section}>
        <Container maxWidth="lg">
          <Typography variant="h3" component="h3" className={`${classes.home_count_title} ${classes.home_carosol_title_padding}`}>
            Our Achievements
          </Typography>
              ...
              {home_count.map((item, index) => (
                <Grid item xs={12} sm={6} md={3} key={index}>
                  <Box className={classes.count_icon_box}>
                    <Box className={classes.count_icon}>
                      {item.icon}
                    </Box>
                    <Box className={classes.count_content}>
                      <Typography variant="h4" component="h4" className={classes.count_title}>
                        {item.title}
                      </Typography>
                      <Typography variant="h4" component="p" className={classes.count_des}>
                        {item.des}
                      </Typography>
                    </Box>
                  </Box>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <Box className={classes.home_blog_box}>
              <Grid container spacing={3}>
                <Grid item md={4} sm={4} xs={12}><Blog /></Grid>
                <Grid item md={4} sm={4} xs={12}><Blog /></Grid>
                <Grid item md={4} sm={4} xs={12}><Blog /></Grid>
              </Grid>
            </Box>
